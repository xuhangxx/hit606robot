...
{	
    ros::init(argc, argv, "control_nodesn2");
    ros::NodeHandle nh;
    ...
    ctrmode.ctrmodeback=7;
    if(!nh.getParam("cp0", cp0))
        cp0 = 1e-3;
    if(!nh.getParam("cp7", cp7))
        cp7 = 1e-3;
    if(!nh.getParam("cp8", cp8))
        cp8 = 1e-9;
    if(!nh.getParam("cp14", cp14))
        cp14 = 1e6;
    if(!nh.getParam("cp21", cp21))
        cp21 = 1e6;
    if(!nh.getParam("cp28", cp28))
        cp28 = 1e6;
    if(!nh.getParam("cp35", cp35))
        cp35 = 1e-9;
    if(!nh.getParam("ct0", ct0))
        ct0 = 1e-9;
    if(!nh.getParam("ct7", ct7))
        ct7 = 1e-3;
    if(!nh.getParam("ct8", ct8))
        ct8 = 1e-9;
    if(!nh.getParam("ct14", ct14))
        ct14 = 1e6;
    if(!nh.getParam("ct21", cp21))
        ct21 = 1e6;
    if(!nh.getParam("ct28", ct28))
        ct28 = 1e6;
    if(!nh.getParam("ct35", ct35))
        ct35 = 1e-9;
    if(!nh.getParam("cpv0", cpv0))
        cpv0 = 1e-3;
    if(!nh.getParam("cpv8", cp8))
        cpv8 = 0;
    if(!nh.getParam("cpv35", cpv35))
        cpv35 = 1e3;
    if(!nh.getParam("ctv0", ctv0))
        ctv0 = 1e-3;
    if(!nh.getParam("ctv8", ct8))
        ctv8 = 0;
    if(!nh.getParam("ctv35", ctv35))
        ctv35 = 1e3;
    ...
    while(ros::ok())
	{
        ...
        else
        {
            ...
            while(!flagmulu0)
            {
                ...
                if(exist(mulu2.str()))
                {
                    ifstream myfile("/home/x805/catkin_ws/src/indoor_navigation/maps/chushisn.txt");

...
from gps_common2.msg import GPSFix
from gps_common2.msg import GPSStatus


def navsatfix_to_gpsfix(navsat_msg):
    # Convert sensor_msgs/NavSatFix messages to gps_common2/GPSFix messages
    gpsfix_msg = GPSFix()
...
def gpsfix_to_navsatfix(gpsfix_msg):
    # Convert gps_common2/GPSFix messages to sensor_msgs/NavSatFix messages
